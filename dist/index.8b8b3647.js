...
})({"i2Laz":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "aa9dba8ca27d5955";
module.bundle.HMR_BUNDLE_ID = "8123a52c8b8b3647"; // @flow
...
},{}],"4ptP0":[function(require,module,exports) {
 ...
 */ var Tweenable1 = function() {
                        ...
                        if (typeof window !== 'undefined') // requestAnimationFrame() shim by Paul Irish (modified for Shifty)
                        ...
                        else DEFAULT_SCHEDULE_FUNCTION = setTimeout;
                        function noop() {
                        // NOOP!
                        }
                        /**
   ...
   */ function defaults(target, src) {
                            each(src, function(prop) {
                                if (typeof target[prop] === 'undefined') target[prop] = src[prop];
                            });
                        }
                        /**
   ...
   */ function applyFilter(tweenable, filterName) {
                            var filters = Tweenable2.prototype.filter;
                            var args = tweenable._filterArgs;
                            each(filters, function(name) {
                                if (typeof filters[name][filterName] !== 'undefined') filters[name][filterName].apply(tweenable, args);
                            });
                        }
   ...
   */ function timeoutHandler(tweenable, timestamp, delay, duration, currentState, originalState, targetState, easing, step, schedule, opt_currentTimeOverride) {
                            ...
                            if (tweenable.isPlaying()) {
                                if (timeoutHandler_isEnded) {
                                    ...
                                    if (timeoutHandler_currentTime < timestamp + delay) tweenProps(1, currentState, originalState, targetState, 1, 1, easing);
                                    else tweenProps(timeoutHandler_currentTime, currentState, originalState, targetState, duration, timestamp + delay, easing);
   ...
   */ function composeEasingObject(fromTweenParams, easing) {
                            ...
                            if (typeofEasing === 'string' || typeofEasing === 'function') each(fromTweenParams, function(prop) {
   ...
   * @module Tweenable
   * @constructor
   */ function Tweenable2(opt_initialState, opt_config) {
   ...
   * `{{#crossLink "Tweenable/setConfig:method"}}{{/crossLink}}`.
   * @chainable
   */ Tweenable2.prototype.tween = function(opt_config) {
   ...
   * @chainable
   */ Tweenable2.prototype.setConfig = function(config) {
                            config = config || {
                            };
                            ...
                            this._currentState = shallowCopy({
                            }, config.from) || this.get();
                            this._originalState = this.get();
                            this._targetState = shallowCopy({
                            }, config.to) || this.get();
                            var self = this;
   ...
   */ Tweenable2.prototype.get = function() {
                            return shallowCopy({
                            }, this._currentState);
                        };
                        /**
   ...
   */ Tweenable2.prototype.set = function(state) {
   ...
   * @method pause
   * @chainable
   */ Tweenable2.prototype.pause = function() {
   ...
   * @method resume
   * @chainable
   */ Tweenable2.prototype.resume = function() {
   ...
   * @chainable
   */ Tweenable2.prototype.seek = function(millisecond) {
   ...
   * @method stop
   * @chainable
   */ Tweenable2.prototype.stop = function(gotoEnd) {
   ...
   */ Tweenable2.prototype.isPlaying = function() {
   ...
   */ Tweenable2.prototype.setScheduleFunction = function(scheduleFunction) {
   ...
   * @method dispose
   */ Tweenable2.prototype.dispose = function() {
                            var prop;
   ...
   */ Tweenable2.prototype.formula = {
                            linear: function(pos) {
                                return pos;
                            }
                        };
                        formula = Tweenable2.prototype.formula;
                        shallowCopy(Tweenable2, {
                            'now': now,
                            'each': each,
                        ...
                        if (typeof SHIFTY_DEBUG_NOW === 'function') root.timeoutHandler = timeoutHandler;
                        // Bootstrap Tweenable appropriately for the environment.
                        if (typeof exports1 === 'object') // CommonJS
                        module1.exports = Tweenable2;
                        else if (typeof define === 'function' && define.amd) // AMD
                        define(function() {
                            return Tweenable2;
                        });
                        else if (typeof root.Tweenable === 'undefined') // Browser: Make `Tweenable` globally accessible.
                        root.Tweenable = Tweenable2;
                        return Tweenable2;
                    }();
                    (function() {
                        Tweenable1.shallowCopy(Tweenable1.prototype.formula, {
                    ...
                    (function() {
                        ...
                        function cubicBezierAtTime(t, p1x, p1y, p2x, p2y, duration) {
                            ...
                            function sampleCurveX(t1) {
                                return ((ax * t1 + bx) * t1 + cx) * t1;
                            }
                            function sampleCurveY(t1) {
                                return ((ay * t1 + by) * t1 + cy) * t1;
                            }
                            function sampleCurveDerivativeX(t1) {
                                return (3 * ax * t1 + 2 * bx) * t1 + cx;
                            }
                            function solveEpsilon(duration1) {
                                return 1 / (200 * duration1);
                            }
   ...
   */ Tweenable1.setBezierFunction = function(name, x1, y1, x2, y2) {
                            ...
                            return Tweenable1.prototype.formula[name] = cubicBezierTransition;
                        };
                        /**
   ...
   * @return {function}
   */ Tweenable1.unsetBezierFunction = function(name) {
                            delete Tweenable1.prototype.formula[name];
                        };
                    })();
                    (function() {
                        function getInterpolatedValues(from, current, targetState, position, easing, delay) {
                            return Tweenable1.tweenProps(position, current, from, targetState, 1, delay, easing);
                        }
                        // Fake a Tweenable and patch some internals.  This approach allows us to
                        // skip uneccessary processing and object recreation, cutting down on garbage
                        // collection pauses.
                        var mockTweenable = new Tweenable1();
   ...
   * @return {Object}
   */ Tweenable1.interpolate = function(from, targetState, position, easing, opt_delay) {
                            var current = Tweenable1.shallowCopy({
                            }, from);
                            var delay = opt_delay || 0;
                            var easingObject = Tweenable1.composeEasingObject(from, easing || 'linear');
                            mockTweenable.set({
                            });
                            ...
                            Tweenable1.applyFilter(mockTweenable, 'tweenCreated');
                            Tweenable1.applyFilter(mockTweenable, 'beforeTween');
                            var interpolatedValues = getInterpolatedValues(from, current, targetState, position, easingObject, delay);
                            // Transform values back into their original format
                            Tweenable1.applyFilter(mockTweenable, 'afterTween');
   ...
   */ function getFormatStringFrom(formattedString) {
                            ...
                            if (!chunks) // chunks will be null if there were no tokens to parse in
                            ...
                            // digit)...
                            formattedString[0].match(R_NUMBER_COMPONENT)) // ...prepend an empty string here to make sure that the formatted number
   ...
   */ function sanitizeObjectForHexProps(stateObject) {
                            Tweenable2.each(stateObject, function(prop) {
   ...
   */ function expandFormattedProperties(stateObject, formatManifests) {
                            Tweenable2.each(formatManifests, function(prop) {
                                var currentProp = stateObject[prop];
                                var rawValues = getValuesFrom(currentProp);
                                var rawValuesLength = rawValues.length;
   ...
   */ function expandEasingObject(easingObject, tokenData) {
                            Tweenable2.each(tokenData, function(prop) {
   ...
   */ function collapseEasingObject(easingObject, tokenData) {
                        ...
                        Tweenable2.prototype.filter.token = {
...
},{}]},["i2Laz","4ptP0"], "4ptP0", "parcelRequirea564")

//# sourceMappingURL=index.8b8b3647.js.map
